...
const handleStatus=async(id)=>{
  ...
  return (
    <div className='container mb-3'>
      <div className="row justify-center align-middle g-3">
    ...
    <div className='grid col-md-5 col-sm-12 text-center'>
      <h1 className={styles.title}>Orders</h1>
      <table className='table-bordered p-20 col-md-12 text-center'>
        <tbody>
          <tr className={styles.trTitle}>
            <th>Id</th>
            <th>Customer</th>
